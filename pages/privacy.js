...
export default class privacy extends Component {
  render() {
    return (
      <Layout>
        <center>
          <Container style={{ position: 'relative', height: 'auto' }}>
            <div style={{ marginTop: '75px' }}>
              <h3>LukeWarm Privacy Policy</h3>
            </div>
            <div
              style={{
                padding: '100px',
            ...
            >
              <p>
                ...
                from LukeWarm.com (the “Site”). PERSONAL INFORMATION WE COLLECT
                ...
                to disable cookies, visit http://www.allaboutcookies.org. - “Log
                ...
                Order Information. HOW DO WE USE YOUR PERSONAL INFORMATION? We
                use the Order Information that we collect generally to fulfill
                ...
                marketing and advertising campaigns). SHARING YOUR PERSONAL
                ...
                Information here: https://www.shopify.com/legal/privacy. We also
                ...
                https://tools.google.com/dlpage/gaoptout. Finally, we may also
...
[[
  ...
  COMMON LINKS INCLUDE:
    ...
    BING - https://advertise.bingads.microsoft.com/en-us/resources/policies/personalized-ads
                ...
                http://optout.aboutads.info/. DO NOT TRACK Please note that we
                do not alter our Site’s data collection and use practices when
...
Additionally, if you are a European resident we note that we are processing your information in order to fulfill contracts we might have with you (for example if you make an order through the Site), or otherwise to pursue our legitimate business interests listed above.  Additionally, please note that your information will be transferred outside of Europe, including to Canada and the United States. */}
                ...
                you ask us to delete this information. No age RESTRICTION.
                ...
                other operational, legal or regulatory reasons. CONTACT US For
                more information about our privacy practices, if you have
                questions, or if you would like to make a complaint, please
                contact us by e-mail at jonathandiaz0914@gmail.com.
              </p>
            </div>
          </Container>
        </center>
